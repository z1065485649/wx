...
<template>
    <div class="content">
        <Row>
            ...
            <MenuTree v-model="selectPath" @levelOnClick="levelOnClick" :node="menus" :level="1" :left="40" :isRoot="true" @addChild="addChild" @editNode="editResource" @deleteNode="deleteResource" @></MenuTree>
            </Col>
